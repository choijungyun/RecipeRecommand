...
public class EditDetailActivity2 extends FontActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_detail2);
        ...
        intent = new Intent(EditDetailActivity2.this, RefrigeratorActivity.class);
        ...
        btn_disease.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(EditDetailActivity2.this);
    ...
    private class GetData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(EditDetailActivity2.this,
